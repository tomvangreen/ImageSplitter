...
public class TextureSplitterBuilder {
	...
	private TextureSplitterListener defaultListener;

	private TextureSplitter ensure() {
		if (splitter == null) {
			splitter = new TextureSplitter();
			splitter.listener = defaultListener;
		}
		return splitter;
	}

	public TextureSplitterBuilder defaultListener(TextureSplitterListener listener) {
	...
	public TextureSplitterBuilder listener(TextureSplitterListener listener) {
		ensure();
		splitter.listener = listener;
		return this;
	}
